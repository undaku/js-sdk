...
exports.ObjectPermissionSource =
...
var UndakuSdk = /** @class */ (function () {
  ...
  UndakuSdk.prototype.getHeaders = function (
    customHeaders,
    skipToken,
    instance,
    token,
    ...
    var headers =
      skipToken || !token || token.length === 0
        ? __assign(__assign({}, defaultHeader), customHeaders)
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              axios_1['default'].post(url, query, {
                headers: this.getHeaders({}),
                baseURL: this.baseUrl,
              }),
            ];
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 2:
            ...
            return [
              4 /*yield*/,
              axios_1['default'].post(url, record, {
                headers: this.getHeaders({}),
                baseURL: this.baseUrl,
              }),
            ];
          case 3:
            ...
            return [
              2 /*return*/,
              { data: response.data.createdId, error: null, message: message },
            ];
          case 4:
            error_3 = _a.sent();
      ...
      return __generator(this, function (_h) {
        switch (_h.label) {
          ...
          case 8:
            ...
            refRecord = refRecords[i];
            if (!refRecord) return [3 /*break*/, 10];
            return [4 /*yield*/, this.createRecord(refRecord.form, refRecord)];
          case 9:
            res = _h.sent();
            if (res && !res.error && res.data) {
  ...
  UndakuSdk.prototype.getRecordCount = function (form, query) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, this.search(form, query)];
          case 1:
            records = _a.sent();
            return [
              2 /*return*/,
              records.error ? -1 : (records.data && records.data.length) || 0,
            ];
        }
      });
    });
  ...
  UndakuSdk.prototype.checkIfRecordExist = function (form, query) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, this.getRecordCount(form, query)];
          case 1:
            recordLength = _a.sent();
            return [
              2 /*return*/,
              recordLength > 0 ? 1 : recordLength < 0 ? -1 : 1,
            ];
        }
      });
    });
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              axios_1['default'].put(url, record, {
                headers: this.getHeaders({}),
                baseURL: this.baseUrl,
              }),
            ];
          case 2:
            ...
            return [
              2 /*return*/,
              { data: response.data.createdId, error: null },
            ];
          case 3:
            error_7 = _a.sent();
        ...
        switch (_a.label) {
          ...
          case 2:
            ...
            return [
              2 /*return*/,
              {
                data: response.data && response.data.data.records,
                error: null,
              },
            ];
          case 3:
