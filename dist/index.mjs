        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, axios.post("/api/login", {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, axios.post(url, query, {
                                headers: this.getHeaders({}),
                                baseURL: this.baseUrl,
                            })];
                    case 2:
                        ...
                        return [4 /*yield*/, axios.get("/api/search", {
                                headers: this.getHeaders({}),
                                baseURL: this.baseUrl,
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, axios.post(url, record, {
                                headers: this.getHeaders({}),
                                baseURL: this.baseUrl,
                            })];
                    case 2:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, axios.put(url, record, {
                                headers: this.getHeaders({}),
                                baseURL: this.baseUrl,
                            })];
                    case 2:
...
})(ObjectPermissionSource || (ObjectPermissionSource = {}));

export { ObjectPermissionSource, PermissionLevel, UndakuSdk };
